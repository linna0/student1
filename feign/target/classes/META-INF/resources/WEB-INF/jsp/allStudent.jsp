...
<div class="container">
        ...
        <div class="col-md-12 column">
            <div class="page-header">
                <h1>
                    ...
                    <button class="btn btn-info"><a href="${pageContext.request.contextPath}/feign/toAddStudent">
                        <img src="${pageContext.request.contextPath}/images/添加.png" style="width:20px;height:20px;">
                    </a></button>
                </h1>
            </div>
        </div>
    ...
    <div class="column col-4" style="padding-left:50px;padding-bottom:0">
        <form action="${pageContext.request.contextPath}/feign/allScoreById" method="post" class="form-inline">
        ...
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/feign/toupdateStudent1?s_no=${num1}&c_no=${s3}">
                        <img src="${pageContext.request.contextPath}/images/修改.png" style="width:20px; height: 20px">
                    </a>
                        <a href="${pageContext.request.contextPath}/feign/deleteScore?s_no=${num1}&c_no=${s3}">
                            <img src="${pageContext.request.contextPath}/images/delete.png" style="width:20px; height: 20px">
                        </a>
                    </td>
